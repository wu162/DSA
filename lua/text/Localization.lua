...
Localization._text_sources = {
    -- === 升级系统 ===
    ["upgrade.tech.airpower"] = { zh = "%s$p%dName取得空军升级!", en = "%s$p%dName received the Air Power upgrade!" },
    ["upgrade.tech.high_technology"] = { zh = "%s$p%dName取得高科技升级!", en = "%s$p%dName received the High Technology upgrade!" },
    ["upgrade.tech.crush_puppies"] = { zh = "%s$p%dName取得碾压升级!", en = "%s$p%dName received the Crush Puppies upgrade!" },
    ["upgrade.tech.terror_drone_eggs"] = { zh = "%s$p%dName取得蜘蛛升级!", en = "%s$p%dName received the Terror Drone Eggs upgrade!" },
    ["upgrade.tech.naval_power"] = { zh = "%s$p%dName取得海军协议!", en = "%s$p%dName received the Naval Power protocol!" },
    ["upgrade.tech.enhanced_kamikaze"] = { zh = "%s$p%dName取得光荣自爆!", en = "%s$p%dName received the Glorious Self-Destruct upgrade!" },
    ["upgrade.tech.advanced_missile_packs"] = { zh = "%s$p%dName取得先进弹药匣!", en = "%s$p%dName received the Advanced Missile Packs upgrade!" },
    ["upgrade.tech.electromagnetic_gun"] = { zh = "%s$p%dName取得电磁炮!", en = "%s$p%dName received the Electromagnetic Gun upgrade!" },
    ["upgrade.tech.power_seal_off_now"] = { zh = "%s$p%dName获得电能纳贡，解锁蓄元鼎建造权限!", en = "%s$p%dName gained the power tribute and unlocked Celestial Battery construction!" },
    ["upgrade.tech.power_seal_off_later"] = { zh = "%s$p%dName获得电能纳贡，第3回合后解锁蓄元鼎建造权限!", en = "%s$p%dName gained the power tribute. Celestial Battery construction unlocks after round 3!" },
    ["upgrade.tech.production_bonus_allied"] = { zh = "%s$p%dName获得盟军自由贸易协议，取得经济提升!", en = "%s$p%dName gained the Allied Free Trade Agreement and received an economic boost!" },
    ["upgrade.tech.production_bonus_japan"] = { zh = "%s$p%dName获得帝国机械化组装协议，解锁全体坦克护盾技能", en = "%s$p%dName gained the Empire mechanized assembly protocol and unlocked tank shield skills for all units!" },
    ["upgrade.tech.production_bonus_soviet"] = { zh = "%s$p%dName获得苏联大生产协议，全体单位降价", en = "%s$p%dName gained the Soviet mass-production protocol. All units are cheaper!" },
    -- 升级完成提示（有序）
    ["upgrade.Upgrade_AlliedMissileIntercept"] = { zh = "取得先进反导系统!", en = "Unlocked Advanced Missile Intercept System!" },
    ["upgrade.Upgrade_AlliedPrismTankReduceSpeed"] = { zh = "取得激光协调矩阵!", en = "Unlocked Laser Coordination Matrix!" },
    ["upgrade.Upgrade_AlliedAircraftAutoDivideBombs"] = { zh = "取得智能航电系统!", en = "Unlocked Smart Avionics System!" },
    ["upgrade.Upgrade_AlliedAdvancedPrismEquipment"] = { zh = "取得先进稳相光学设备!", en = "Unlocked Advanced Phase-Stable Optical Equipment!" },
    ["upgrade.Upgrade_AlliedCommandControlSystem"] = { zh = "取得战场全面信息化!", en = "Unlocked Battlefield Informatization!" },
    ["upgrade.Upgrade_AlliedAircraftCarrierDrone"] = { zh = "取得先进航空指挥系统!", en = "Unlocked Advanced Air Command System!" },
    ["upgrade.Upgrade_SovietMissileIntercept"] = { zh = "获得防空火控雷达!", en = "Unlocked Anti-Air Fire Control Radar!" },
    ["upgrade.Upgrade_SovietCompositeArmor"] = { zh = "获得外附装甲!", en = "Unlocked Add-On Armor!" },
    ["upgrade.Upgrade_SovietImprovedTeslaCoil"] = { zh = "获得预充能线圈!", en = "Unlocked Pre-Charged Coil!" },
    ["upgrade.Upgrade_SovietMultiModeGuidance"] = { zh = "获得目标识别导引头!", en = "Unlocked Target Recognition Seeker!" },
    ["upgrade.Upgrade_JapanSubmarineAttack"] = { zh = "获得潜航发射!", en = "Unlocked Submarine Launch!" },
    ["upgrade.Upgrade_JapanMechaRush"] = { zh = "获得机甲冲击!", en = "Unlocked Mecha Charge!" },
    ["upgrade.Upgrade_JapanNanoTransmissionStructure"] = { zh = "获得高强度机械变形框架!", en = "Unlocked High-Strength Mechanical Transformation Frame!" },
    ["upgrade.Upgrade_JapanNanoSustainingForceField"] = { zh = "获得纳米维持力场!", en = "Unlocked Nano Sustaining Force Field!" },
    ["upgrade.Upgrade_CelestialSpeedUpdate"] = { zh = "获得电掣之势!", en = "Unlocked Lightning Speed!" },
    ["upgrade.Upgrade_CelestialSupplyElectricitySystem"] = { zh = "获得超导电枢!", en = "Unlocked Superconducting Armature!" },
    ["upgrade.Upgrade_CelestialAuxiliaryAimingSystem"] = { zh = "获得穿云定海!", en = "Unlocked Piercing Cloud and Calming Sea!" },
    ["upgrade.Upgrade_CelestialLodestarDevice"] = { zh = "获得移星换位!", en = "Unlocked Stellar Shift!" },
    ["upgrade.Upgrade_JapanIntelligentAmmunition"] = { zh = "获得白田火控AI!", en = "Unlocked Baitian Fire Control AI!" },
    ["upgrade.Upgrade_SovietGloriousArmedForce"] = { zh = "获得光荣武装!", en = "Unlocked Glorious Armament!" },
    ["upgrade.Upgrade_AlliedCryoWeaponArray"] = { zh = "获得冰冻武器阵列!", en = "Unlocked Frozen Weapon Array!" },
    ...
    -- === 技能系统 ===
    ["skill.name.1"] = { zh = "炸弹+达摩克利斯之剑", en = "Bomb + Damocles Sword" },
    ["skill.name.2"] = { zh = "铁幕+时停", en = "Iron Curtain + Time Stop" },
    ["skill.name.3"] = { zh = "龙船+空军元帅", en = "Dragon Ship + Air Marshal" },
    ["skill.name.4"] = { zh = "补充军队+纳米维修", en = "Reinforce Army + Nano Repair" },
    ["skill.name.5"] = { zh = "复制己方技能+复制敌方技能", en = "Copy Friendly Skills + Copy Enemy Skills" },
    ["skill_mode.dialog.title"] = { zh = "请选择技能组模式", en = "Please choose a skill group mode" },
    ["skill_mode.choose_yourself"] = { zh = "让每个玩家自行选择", en = "Let each player choose for themselves" },
    ["skill_mode.host_symmetric"] = { zh = "房主规定技能组(对称)", en = "Host-defined skill groups (symmetric)" },
    ["skill_mode.random_symmetric"] = { zh = "随机（可重复，对称）", en = "Random (repeatable, symmetric)" },
    ["skill_mode.random_asymmetric"] = { zh = "随机（可重复，不对称）", en = "Random (repeatable, asymmetric)" },
    ...
    ["market.title"] = { zh = "欢迎进入交易市场", en = "Welcome to the Trading Market" },
    ["market.title_with_investment"] = { zh = "欢迎进入交易市场\n投资金额(上限%d):%d", en = "Welcome to the Trading Market\nInvestment amount (cap %d): %d" },
    ...
    ["market.next_investment.benefit"] = { zh = "\n若回合胜利可获收益", en = "\nIf your side wins the round, you will receive a return" },
    ["market.transfer.choice"] = { zh = "向%s%s转移1000资金", en = "Transfer 1000 credits to %s%s" },
    ["market.back_to_battle"] = { zh = "回到战场", en = "Back to Battle" },
    ["market.buy_shield_tower"] = { zh = "购买护盾塔(%d)", en = "Buy Shield Tower (%d)" },
    ["market.buy_poplar_tower"] = { zh = "购买胡杨塔(%d)", en = "Buy Poplar Tower (%d)" },
    ["market.transfer.success"] = { zh = "成功转账1000给$p%dName", en = "Successfully transferred 1000 credits to $p%dName" },
    ...
    ["market.tower.already_exists"] = { zh = "护盾塔还在，不能购买", en = "The tower is still alive, you cannot buy another one" },
    ...
    ["button.market.description"] = { zh = "购买理财项目或者定向转移资金", en = "Buy investment products or transfer funds to a specific target" },
    ...
    ["button.damocles.description"] = { zh = "请求太空的卫星对敌方随机单位启用12秒的精准卫星打击", en = "Request a satellite strike from space against a random enemy unit for 12 seconds" },
    ...
    ["button.time_stop.description"] = { zh = "借助未来科技的力量时停对方单位13秒", en = "Use future technology to time-stop enemy units for 13 seconds" },
    ...
    ["button.air_marshal.description"] = { zh = "请求超级苏霍伊群抵达战场对敌方的空军造成毁灭性的攻击\n【仅对空、不可攻击敌方空军元帅】", en = "Request a super Su-27 squad to reach the battlefield and deal devastating damage to enemy air units\n[Air only; cannot attack the enemy Air Marshal]" },
    ...
    ["center_top.temporal_raid.title"] = { zh = "超时空突袭", en = "Temporal Raid" },
    ...
    ["center_top.morale_boost.description"] = { zh = "请获得止戈立场以解锁此按钮", en = "Obtain Celestial Morale to unlock this button" },
    ...
    ["center_top.used.temporal_raid"] = { zh = "%s方使用了超时空突袭！", en = "%s used Temporal Raid!" },
    ["center_top.kill_reward.title"] = { zh = "杀敌奖励", en = "Kill Reward" },
    ["center_top.kill_reward.description"] = { zh = "为所有敌方陆地单位（不包括空军）套上钱套子(持续30秒)，击杀后使用技能者获得金钱(冷却40秒)", en = "Apply money-kitten to all enemy land units (30s); killing grants money (40s cooldown)" },
    ...
    ["center_top.japan_shield.title"] = { zh = "全体护盾", en = "All Shields" },
    ["center_top.japan_shield.description"] = { zh = "请激活帝国最高机密协议「机械化组装」以解锁此按钮", en = "Activate Empire mech protocol to unlock" },
    ["center_top.japan_shield.unlocked_description"] = { zh = "为所有己方载具套上纳米护盾\n冷却时间200秒", en = "Apply nano shields to all friendly vehicles; 200s cooldown" },
    ...
    ["center_top.used.dragon_core_called"] = { zh = "%s方召唤了青龙核心战斗舰！", en = "%s summoned Dragon Core Ship!" },
    ...
    ["center_top.error.player_not_obtained_morale"] = { zh = "错误：玩家 %d 尚未获得止戈立场。", en = "Error: player %d hasn't obtained Morale Field." },
    ["center_top.error.no_tank_found"] = { zh = "错误：没有找到任何坦克单位，无法施加纳米护盾。", en = "Error: no tank units found, cannot apply nano shield." },
    ["center_top.error.no_land_unit_found"] = { zh = "错误：没有找到任何陆地单位，无法释放杀敌奖励", en = "Error: no land units found, cannot cast kill reward" },
    ...
    ["center_top.used.emp_nano_shield"] = { zh = "%s $p%dName使用了由帝国机械化组装协议提供的纳米护盾！", en = "%s $p%dName used Empire Nano Shield!" },
    ["center_top.used.kill_reward"] = { zh = "%s方使用了杀敌奖励！", en = "%s used Kill Reward!" },
    ["center_top.used.global_morale"] = { zh = "%s $p%dName使用了由止戈立场提供的全图士气提升技能！", en = "%s $p%dName used Global Morale Skill!" },
    ...
    ["mirrortower.unlock_t4_ship.devil"] = { zh = "恶魔方摧毁敌方海3塔，立即释放一次达摩克利斯之剑(不消耗释放次数)!", en = "Devils destroyed the enemy sea tower 3 and immediately triggered Damocles Sword once (no charge consumed)!" },
    ["mirrortower.unlock_t4_ship.angel"] = { zh = "天使方摧毁敌方海3塔，立即释放一次达摩克利斯之剑(不消耗释放次数)!", en = "Angels destroyed the enemy sea tower 3 and immediately triggered Damocles Sword once (no charge consumed)!" },
...
Localization.recycle = function(key, ...)
    ...
    if strsub(key, 1, 5) == "unit." then
        ...
        local actual_key = "NAME:" .. unit_key
        local translated = TextTranslate(actual_key)
        if translated ~= actual_key then
            return translated
        else

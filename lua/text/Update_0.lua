...
function onUserLongTextDialogEvent(playerName, btnIndex, dialogId)
    ...
    if btnIndex == 1 then
        ...
        exShowLongTextDialog(dialogId - 1, g_UpdateBoxText[dialogId - 1], prev,'清楚!', '下一页')
    end
    ...
    if btnIndex == 3 then
        ...
        exShowLongTextDialog(dialogId + 1, g_UpdateBoxText[dialogId + 1], '上一页','清楚!', next)
    end
